...
<div class="row">
    <div class="col-md-6 mx-auto">
        <div class="card bg-light mt-5">
            ...
            <p class="card-text">Please Fill out This form to sign up with us</p>
            </div>
                ...
                <form method="post" action="<?php echo URLROOT ;?>/users/signup">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col">
                                <a href="<?php echo URLROOT ;?>/users/signin" class="btn btn-light btn-block pull-right">Already have account? Sign In </a>
                            </div>
                        </div>
                    </div>
                </form>
